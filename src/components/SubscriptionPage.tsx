...
const SubscriptionPage: React.FC<{ onOpenMenu: () => void }> = ({ onOpenMenu }) => {
  ...
  return (
    <div className="page animate-in">
      ...
      <button style={{ background: 'none', border: 'none', width: '100%', color: '#8D6E63', fontSize: '0.82rem', cursor: 'pointer' }}>
        {t('restore_purchases') || 'Restore Purchases'}
      </button>

      <p style={{ textAlign: 'center', fontSize: '0.68rem', color: '#BCAAA4', marginTop: 12, lineHeight: 1.5, paddingBottom: 40 }}>
