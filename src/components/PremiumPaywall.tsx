  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#212529', marginBottom: 8 }}>{t('unlock_premium') || 'Unlock Premium'}</h2>
        ...
        <button onClick={() => navigate(-1)} className="btn btn-full" style={{ background: 'transparent', color: '#6C757D', fontSize: '0.85rem' }}>
